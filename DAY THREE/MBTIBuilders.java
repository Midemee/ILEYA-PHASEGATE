...
public class MBTIBuilders{
       public static String calculateMBTI(String[] answers){
       int extrovert = 0;
       int introvert = 0;
       int sensing = 0;
       int intuition = 0;
    ...
    Scanner inputCollector = new Scanner(System.in);
        ...
        System.out.println("TAKE MBTI PERSONALITY TEST");
        for(int index = 0; index < questions.length; index++){
        boolean testRunning = true;
            while(testRunning){
                System.out.println(questions[index]);
                System.out.print("Select A or B: ");
                String userChoice = inputCollector.nextLine().toUpperCase();
                System.out.println();
       ...
       String result = calculateMBTI(answers);
        System.out.printf("%nPERSONALITY RESULT%nMBTI Type is: %s%n", result); 
    ...
    switch (result) {
        ...
        default:
            System.out.println("Personality type not found.");
    }
